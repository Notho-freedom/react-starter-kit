...
const TripDetailsBookingSidebar = () => (
  <>
          ...
          <div className="bg-brand-surfaceLight rounded-3xl p-6 md:p-8 border border-gray-700 shadow-2xl">
            ...
            <div className="mb-8">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-xs text-brand-accentYellow">2 places restantes</span>
              </div>
            ...
            <div className="space-y-3 mb-8">
              <div className="flex justify-between text-sm">
                <span className="text-brand-textMuted">1 Place</span>
              ...
              <div className="pt-3 border-t border-gray-700 flex justify-between text-base font-bold">
                ...
                <span className="text-brand-accentGreen">€38.50</span>
              </div>
            </div>
            <button
              type="button"
