      ...
      <form className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-1.5">
              ...
              <div className="relative input-field rounded-xl">
                <input type="text" placeholder="John" className="w-full px-4 py-3 rounded-xl focus:outline-none text-gray-900 bg-transparent placeholder-gray-400" required />
              </div>
            </div>
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-gray-700">Last Name</label>
              <div className="relative input-field rounded-xl">
                <input type="text" placeholder="Doe" className="w-full px-4 py-3 rounded-xl focus:outline-none text-gray-900 bg-transparent placeholder-gray-400" required />
              </div>
            </div>
          </div>
          <div className="space-y-1.5">
            ...
            <div className="relative input-field rounded-xl flex">
              <select className="bg-gray-50 border-r border-gray-200 px-3 py-3 rounded-l-xl text-gray-700 focus:outline-none">
                <option>+1 (US)</option>
                <option>+44 (UK)</option>
                <option>+33 (FR)</option>
              </select>
              <input type="tel" placeholder="(555) 000-0000" className="flex-1 px-4 py-3 rounded-r-xl focus:outline-none text-gray-900 bg-transparent placeholder-gray-400" required />
            </div>
        ...
        <div id="section-localization" className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-1.5">
              ...
              <div className="relative input-field rounded-xl">
                <select className="w-full px-4 py-3 rounded-xl focus:outline-none text-gray-900 bg-transparent appearance-none">
        ...
        <div id="section-emergency" className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative input-field rounded-xl">
              <input type="text" placeholder="Jane Doe" className="w-full px-4 py-3 rounded-xl focus:outline-none text-gray-900 bg-transparent placeholder-gray-400" />
            </div>
          </div>
          <div className="space-y-1.5">
            <label className="text-sm font-medium text-gray-700">Contact Phone</label>
            <div className="relative input-field rounded-xl">
              <input type="tel" placeholder="+1 (555) 111-2222" className="w-full px-4 py-3 rounded-xl focus:outline-none text-gray-900 bg-transparent placeholder-gray-400" />
            </div>
          </div>
        </div>
        ...
        <div className="pt-6 border-t mt-8 flex items-center justify-between gap-4 sticky bottom-0 bg-white py-4 z-20">
          <button type="button" className="px-6 py-3.5 text-gray-600 font-medium hover:text-gray-900 transition-colors">
            Skip for now
          </button>
          <button type="button" className="flex-1 sm:flex-none bg-brand-dark hover:bg-black text-white font-semibold px-8 py-3.5 rounded-xl transition-all duration-300 shadow-lg shadow-gray-900/20 flex justify-center items-center gap-2 group">
            Save &amp; Continue
