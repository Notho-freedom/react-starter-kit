    ...
    <div className="w-full lg:w-80 flex-shrink-0 flex flex-col gap-6">
        ...
        <div className="glass-card rounded-2xl p-6 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="relative inline-block mb-4">
              <img src="https://storage.googleapis.com/uxpilot-auth.appspot.com/avatars/avatar-2.jpg" alt="Ronald R." className="w-24 h-24 rounded-full border-4 border-brand-surfaceLight shadow-xl mx-auto object-cover" />
            ...
            <h2 className="text-xl font-bold text-white mb-1">Ronald Richards</h2>
            <p className="text-sm text-gray-400 mb-4">Paris, France • 28 ans</p>
            <div className="flex justify-center gap-4 mb-6">
              <div className="text-center">
                <div className="flex items-center gap-1 text-brand-warning font-semibold text-lg">
                  <OpenRideIcon name="star" className="text-sm" /> 4.8
                </div>
                <span className="text-xs text-gray-500">124 Avis</span>
              </div>
              <div className="w-px h-8 bg-white/10" />
              <div className="text-center">
                <div className="text-white font-semibold text-lg">45</div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-brand-success/10 text-brand-success flex items-center justify-center">
                  <OpenRideIcon name="check" className="text-sm" />
                </div>
                <div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-brand-surface border border-white/10 text-gray-400 flex items-center justify-center">
                  <OpenRideIcon name="id-card" className="text-sm" />
                </div>
                <div>
                  <p className="text-sm font-medium text-white">Pièce d'identité</p>
                  <p className="text-xs text-brand-warning">À vérifier</p>
                </div>
              </div>
              <button className="text-xs text-brand-accentPurple hover:text-white transition-colors font-medium">Ajouter</button>
            </div>
          </div>
          <div className="mt-6 pt-4 border-t border-white/10">
            <a href="#" className="text-sm text-brand-accentPurple hover:text-white transition-colors flex items-center gap-2 font-medium">
        ...
        <div className="glass-card rounded-2xl overflow-hidden">
          <div className="p-2 flex flex-col gap-1">
            ...
            <button className="mt-4 flex items-center gap-3 px-4 py-3 rounded-lg text-left w-full text-brand-error hover:bg-brand-error/10 transition-colors">
