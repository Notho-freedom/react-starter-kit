              ...
              <div className="flex justify-between items-start mb-4">
                <div className="flex flex-col gap-3 relative">
                  ...
                  <div className="flex items-center gap-3 z-10">
                    ...
                    <span className="text-white font-medium">Paris</span>
                  </div>
                  <div className="flex items-center gap-3 z-10">
                    <div className="w-3 h-3 rounded-full border-2 border-brand-accentYellow bg-brand-surface" />
                    <span className="text-white font-medium">Lyon</span>
                  </div>
                </div>
                <div className="text-right">
                  <span className="text-2xl font-bold text-brand-accentGreen">35€</span>
                </div>
              </div>
              <div className="flex items-center justify-between text-sm text-brand-textMuted border-t border-gray-700 pt-4 mt-2">
                <div className="flex items-center gap-2">
                  <OpenRideIcon name="calendar" /> Aujourd'hui, 08:00
                </div>
                <div className="flex items-center gap-2">
                  <OpenRideIcon name="users" /> 3 places
                </div>
              </div>
              <div className="flex gap-2 mt-4">
                <span className="bg-gray-800 text-gray-300 text-xs px-2 py-1 rounded-md"><OpenRideIcon name="suitcase" /> Bagages</span>
              </div>
            </div>
            {/* Publish CTA */}
            <button className="w-full bg-brand-accentGreen hover:bg-[#8be08b] text-brand-dark text-lg font-bold py-4 rounded-xl transition-colors shadow-lg shadow-brand-accentGreen/20 flex items-center justify-center gap-2 mb-4">
